		...
		<main className="min-h-screen bg-background">
			...
			<section className="relative overflow-hidden">
				<div className="pointer-events-none absolute inset-0 -z-10">
					<div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[640px] h-[640px] bg-gradient-to-br from-orange-400/25 via-amber-300/15 to-transparent rounded-full blur-3xl" />
				</div>

				<div className="container mx-auto px-4 pt-20 pb-16">
					<div className="max-w-3xl mx-auto text-center space-y-8">
						<div className="flex flex-col items-center gap-6">
							<div className="p-4 bg-gradient-to-br from-amber-400 to-orange-500 rounded-2xl text-white shadow-lg shadow-orange-500/25">
								<UtensilsCrossed className="w-12 h-12" />
							</div>
							<Badge
								variant="outline"
								className="text-sm px-3 py-1 font-normal border-orange-200 bg-orange-50 text-orange-600"
							>
								v1.0 Beta
							</Badge>
						</div>
			...
			{/* CTA */}
			<section className="container mx-auto px-4 py-16">
				<Card className="max-w-3xl mx-auto border shadow-sm bg-primary/5">
